...
### Recent News 
* **Sep 2024** Paper on [*empowering map prediction with large-scale public data*](https://arxiv.org/abs/2407.08726) accepted to NeurIPS 2024! Looking forward to Vancouver! 
...
<style>
    ...
    #thumbnail-container {
        float: left;
        width: var(--thumbnail-size, 300px); /* Default size is 150px */
        padding-top: 15px;
    }
    #thumbnail {
        width: 100%;
    ...
    #content {
        margin-left: calc(var(--thumbnail-size, 300px) + 20px); /* Adjust margin based on thumbnail size */
    }
</style>
...
<div class="container">
    ...
    <div id="content">
        <a href="https://arxiv.org/abs/2407.08726"><b>Map It Anywhere: Empowering BEV Map Prediction using Large-scale Public Datasets</b></a><br>
...
<div class="container">
    <div id="thumbnail-container">
        <img id="thumbnail" src="img/tube-cartoon.png">
    </div>
    <div id="content">
